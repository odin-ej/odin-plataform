...
export const metadata: Metadata = {
  ...
  description: 'Sistema oficial da Empresa Junior de Administração da UFBA. Somos a primeira Empresa Júnior da Bahia, construindo um legado de sonhos e impulsionando lideranças protagonistas.',
  ...
  openGraph: {
    title: 'Plataforma Empresa JR | UFBA',
    description: 'Gerencie sua jornada na primeira Empresa Junior da Bahia com uma plataforma moderna e intuitiva.',
  ...
  twitter: {
    ...
    title: 'Plataforma Empresa JR | UFBA',
    description: 'Conectando talento, gestão e impacto na primeira Empresa Júnior da Bahia.',
