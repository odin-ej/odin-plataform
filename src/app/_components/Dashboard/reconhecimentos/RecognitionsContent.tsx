...
type RecognitionItem = ScheduleItem["recognitions"][number];
type WinnerItem = RecognitionItem["winners"][number];
      ...
      <section className="space-y-6">
        ...
        activeMonthData.recognitions.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {activeMonthData.recognitions.map((rec: RecognitionItem) => (
