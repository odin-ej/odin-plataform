...
const AssignRecognitionSchema = z.object({
  ...
  media: z.union([z.instanceof(File), z.null()]).optional(),
  scheduleId: z.string(),
});

type AssignRecognitionValues = z.infer<typeof AssignRecognitionSchema>;
...
const AssignRecognitionModal = ({ authorId }: AssignRecognitionModalProps) => {
  ...
  const form = useForm<AssignRecognitionValues>({
  ...
  const onSubmit = async (values: AssignRecognitionValues) => {
