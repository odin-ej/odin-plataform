...
interface CreateReservationModalProps {
  ...
  createRoomReservation: (data: ReservationFormValues) => void;
  createItemReservation: (data: ReservationFormValues) => void;
  createEaufbaRequest: (data: ReservationFormValues) => void;
...
const CreateReservationModal = ({
  ...
  const userHasPermissionToItem = (item: ReservableItem) => {
    ...
    if (
      ...
      return true;
    return userCurrentRoleAreas?.some((area) =>
