...
// Reaction accumulator type for grouping reactions
    ...
    >
      ...
      <div className="relative">
        ...
        >
          ...
          {message.parent && (
            <RenderParentMessage
              message={message.parent as NonNullable<FullMessage['parent']>}
        ...
        {message.reactions && message.reactions.length > 0 && (
          <div className="absolute -bottom-4 left-2 flex flex-wrap gap-1.5 z-10">
            ...
            ).map((reactionData: GroupedReaction) => {
