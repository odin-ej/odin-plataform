...
const EnterprisePageContent = ({
  ...
  const getFieldsForType = (
    ...
    formInstance: UseFormReturn<Record<string, unknown>>
  ...
  const versionFields: FieldConfig<Record<string, unknown>>[] = [
  ...
  const semesterFields: FieldConfig<Record<string, unknown>>[] = [
    ...
    <>
      ...
      <DataManagementPanel
        ...
        onEditVersion={(version) =>
          handleOpenEditModal(version as unknown as Record<string, unknown> & { id: string }, "version")
        }
        ...
        onEditSemester={(semester) =>
          handleOpenEditModal(semester as unknown as Record<string, unknown> & { id: string }, "semester")
        }
