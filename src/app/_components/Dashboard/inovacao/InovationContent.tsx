  ...
  const myFilteredInitiatives = useMemo(() => {
    ...
    return initiatives.filter((item) => {
      ...
      if (
        ...
        !item.subAreas.some((a) => a === myInitiativesFilter.subAreaFilter)
      )
        return false;
      ...
      if (
        ...
        !item.areas.some((a) => a === myInitiativesFilter.areaFilter)
      )
        return false;
  ...
  const filteredInitiatives = useMemo(() => {
    ...
    return initiatives.filter((item) => {
      ...
      if (
        ...
        !item.subAreas.some(
          (a) => a === enterpriseInitiativesFilter.subAreaFilter
        )
      )
        return false;
      ...
      if (
        ...
        !item.areas.some((a) => a === enterpriseInitiativesFilter.areaFilter)
      )
        return false;
