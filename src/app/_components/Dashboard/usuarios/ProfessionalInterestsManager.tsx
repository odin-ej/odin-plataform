...
const ProfessionalInterestsManager = ({
  interestCategories,
}: ProfessionalInterestsManagerProps) => {
  ...
  return (
    <div className="space-y-4 p-4 border border-dashed border-gray-600 rounded-lg">
      ...
      <p className="text-sm text-gray-400">
        Selecione as áreas que mais te interessam. Isso nos ajuda a direcionar
        oportunidades e conteúdos relevantes para você.
      </p>
