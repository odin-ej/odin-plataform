...
interface MemberFormProps<T extends z.ZodTypeAny> {
  title?: string;
  ...
  roles: Role[];
  schema: T;
  onFileSelect?: (file: File, form: ReturnType<typeof useForm<z.infer<T>>>) => void;
...
const MemberForm = <T extends z.ZodTypeAny>({
  title = "Cadastrar",
  values,
  roles,
  canChangeRole,
