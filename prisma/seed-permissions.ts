...
const ROUTE_SEED: Array<{
  ...
  { path: "/central-reservas", label: "Central de Reservas", policyId: "policy-members-only" },
  ...
  { path: "/pendencias", label: "Pendências", policyId: "policy-members-only" },
  ...
  { path: "/salas-eaufba", label: "Salas EAUFBA", policyId: "policy-members-only" },
